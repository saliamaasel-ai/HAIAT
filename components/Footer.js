      ...
      <div className="max-w-[1280px] mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8 py-14">
        <div className="col-span-2 md:col-span-1">
          ...
          <div className="flex gap-2.5">
            <SocialLink href="https://wa.me/77023876843" label="WhatsApp">
            ...
            <SocialLink href="https://instagram.com/https://www.instagram.com/haiat_atyrau?igsh=bGgyODhmMzA0cGt6" label="Instagram" outline>
              <rect x="3" y="3" width="18" height="18" rx="5" /><circle cx="12" cy="12" r="4" /><circle cx="17.5" cy="6.5" r="1" />
            </SocialLink>
            <SocialLink href="https://t.me/https://t.me/access_atyrau" label="Telegram">
        ...
        <div>
          ...
          <a href="tel:+77023876843" className="block text-[13.5px] text-[#B7C0D8] py-1.5 hover:text-white">+7 702 387 68 43</a>
          <a href="mailto:Kazbekovzhandos@gmail.com" className="block text-[13.5px] text-[#B7C0D8] py-1.5 hover:text-white">info@nur.kz</a>
          <Link href="/contact" className="block text-[13.5px] text-[#B7C0D8] py-1.5 hover:text-white">Атырау қ., Шүкр Еркінова 75</Link>
        </div>
      </div>
      <div className="border-t border-white/10 py-5 text-center text-[12.5px] text-[#8B93AC]">
        © {year} HAIAT.kz — Барлық құқықтар қорғалған.
      </div>
    </footer>
  );
}
