...
// Нақты фото қосу үшін: суретті public/images/ қалтасына салыңыз, содан кейін
// тиісті тауар объектісіне мына өрісті қосыңыз (файл атаулары дәл сәйкес болуы керек):
//   images: ["/images/файл-атауы.jpg", "/images/файл-атауы-2.jpg"]
// Бірінші сурет (images[0]) карточкада көрінеді, ал тауар бетінде барлық суреттер
// галерея түрінде (thumbnail-дармен) көрсетіледі. images өрісі жоқ тауарларда
// автоматты түрде SVG иконка көрсетіледі.
